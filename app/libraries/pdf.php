...
require_once($tcpdf['base_directory'].'/config/tcpdf_config.php');
...
class Pdf extends TCPDF {
	...
	function __construct() {
        ...
        public function Footer() {
            ...
            $this->Image($image_file, 0, 0, 200, 40, 'JPG', '', 'T', true, 300, '', false, false, 0, false, false, false);
            ...
            $image_file = './style/footerPdf.jpg';
            $this->Image($image_file, 0, 280, 200, 20, 'JPG', '', 'T', true, 300, '', false, false, 0, false, false, false);
